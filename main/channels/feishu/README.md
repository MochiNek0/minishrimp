...
This directory contains the Feishu bot integration for MiniShrimp.
...
2. Edit `main/shrimp_secrets.h`:

```c
#define SHRIMP_SECRET_FEISHU_APP_ID     "cli_xxxxxxxxxxxxxx"
#define SHRIMP_SECRET_FEISHU_APP_SECRET "xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx"
```
...
### Option 2: Runtime Configuration (Web UI)

Open `http://<ESP32_IP>:18789/config` and fill in Feishu App ID / App Secret, then Save & Restart.
