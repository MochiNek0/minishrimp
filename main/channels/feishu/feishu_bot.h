 ...
 * Listens on SHRIMP_FEISHU_WEBHOOK_PORT.
 */
esp_err_t feishu_bot_start(void);

/**
 * Return true if Feishu credentials are configured.
 */
bool feishu_bot_is_configured(void);

/**
 * Send a text message to a Feishu chat.
 * Automatically splits messages longer than SHRIMP_FEISHU_MAX_MSG_LEN chars.
