 ...
 * Input JSON: {"path": "<SHRIMP_SPIFFS_BASE>/...", "old_string": "...", "new_string": "..."}
 */
 ...
 * Input JSON: {"prefix": "<SHRIMP_SPIFFS_BASE>/..."} (prefix is optional)
 */
