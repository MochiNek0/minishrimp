...
static void register_tool(const shrimp_tool_t *tool)
{
...
esp_err_t tool_registry_init(void)
{
    ...
    shrimp_tool_t rf = {
        .name = "read_file",
        .description = "Read a file from SPIFFS storage. Path must start with " SHRIMP_SPIFFS_BASE "/.",
        .input_schema_json =
            "{\"type\":\"object\","
            "\"properties\":{\"path\":{\"type\":\"string\",\"description\":\"Absolute path starting with " SHRIMP_SPIFFS_BASE "/\"}},"
            "\"required\":[\"path\"]}",
    ...
    shrimp_tool_t wf = {
        .name = "write_file",
        .description = "Write or overwrite a file on SPIFFS storage. Path must start with " SHRIMP_SPIFFS_BASE "/.",
        .input_schema_json =
            "{\"type\":\"object\","
            "\"properties\":{\"path\":{\"type\":\"string\",\"description\":\"Absolute path starting with " SHRIMP_SPIFFS_BASE "/\"},"
    ...
    shrimp_tool_t ld = {
        ...
        .input_schema_json =
            "{\"type\":\"object\","
            "\"properties\":{\"prefix\":{\"type\":\"string\",\"description\":\"Optional path prefix filter, e.g. " SHRIMP_SPIFFS_BASE "/memory/\"}},"
            "\"required\":[]}",
